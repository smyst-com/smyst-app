...
They must not be required by production, CI deployment, Cloudflare Pages,
Cloudflare Workers, GitHub Actions release gates or the smyst.com runtime.

Production must use only:

- GitHub Free for source, documentation and CI within free limits.
- Cloudflare Free for DNS, TLS, CDN, Pages, Workers, KV and edge delivery.
