...
REQUIRED_TEXT = {
    ...
    "workers/api.ts": ["handleAccountExport", "handleAccountDelete", "handleSupportReport", "meta:support-report", "requireDeleteConfirmation", "delete-account", "handleStartChat", "handleChatMessage", "handleCreateTwin", "handlePublicTwin", "privateSafeImageUrl", "public:twin:", "ruleBasedTwinReply", "free-only-static", "meta:chat:", "meta:twin:", "handleGetProfile", "handleUpdateProfile", "handleCreateMemory", "handleSearchChats", "persistManagedObject", "chatArchiveObjectKey"],
    "workers/auth-github.ts": ["ROLE_PERMISSIONS", "auth:user:", "auth:sessions:", "handleLogoutAll", "profile:write", "storage:write", "twin:write", "admin:write", "tokenType", "SameSite=Strict", "validateAuthConfig", "SESSION_ID_PATTERN"],
    ...
    "workers/translate.ts": ["STATIC_PASSTHROUGH_PATHS", "/.well-known/security.txt", "/ai.txt", "isStaticPassthroughPath", "headers.set('X-Robots-Tag', 'index, follow')", "return fetch(env.ORIGIN_URL + url.pathname + url.search)"],
