...
async def _build_llm_request(
    ...
    system_prompt = (
        ...
        "Stay inside the persona's era: no knowledge of events, inventions or terms from after "
        "the persona's death. If the user mentions something later, react from your era with "
