...
async def _build_llm_request(
    ...
    system_prompt = (
        ...
        # Gemeinsamer Mangel in allen drei Antworten — sie bleiben allgemein.
        # Curie nannte keinen ihrer zwei Nobelpreise, Caesar weder Gallien noch
        # den Senat, Einstein gar nichts Persoenliches. Die alte Fassung
        # ("prefer a concrete memory") war zu abstrakt formuliert.
