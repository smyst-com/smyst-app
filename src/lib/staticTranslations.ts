...
export interface StaticTranslations {
  ...
  chatBar: { noProfile: string; selectProfile: string; addMedia: string; messageTo: string; selectPublicProfile: string; selectAiProfileFirst: string; voiceInput: string; voiceInputUnsupported: string; sendMessage: string; notePlaceholder: string }
