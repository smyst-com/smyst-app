...
export const DEFAULT_TRANSLATIONS: StaticTranslations = {
  ...
  cats: { Wissenschaft: 'Wissenschaft', Geschichte: 'Geschichte', Forschung: 'Forschung', Literatur: 'Literatur', Kunst: 'Kunst', Politik: 'Politik', Philosophie: 'Philosophie', Bildung: 'Bildung', Mathematik: 'Mathematik', Ethik: 'Ethik', Technologie: 'Technologie', Wirtschaft: 'Wirtschaft', Medizin: 'Medizin', Führung: 'Führung', Physik: 'Physik', Strategie: 'Strategie', Musik: 'Musik', Architektur: 'Architektur', Erfinder: 'Erfinder' },
